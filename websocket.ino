...
const char* ssid = "My Zone"; //Enter SSID
const char* password = "sreevani"; //Enter Password
const char* websockets_server_host = "kunal-wh-ws.herokuapp.com"; //Enter server adress
